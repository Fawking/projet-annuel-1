...
<option>Congo</option>
<option>Congo, République démocratique du Congo</option>
...
<option>Îles Falkland (Malvinas)</option>
...
<option>Haïti</option>
<option>Île Heard et îles McDonald</option>
<option>Saint-Siège (État de la Cité du Vatican)</option>
...
<option>Iran, République islamique d Iran'</option>
<option>Irak</option>
...
<option>Corée, République populaire démocratique de Corée</option>
<option>Corée, République de Corée</option>
...
<option>Macao</option>
<option>Macédoine, ancienne République de Yougoslavie</option>
...
<option>Micronésie, États fédérés de Micronésie</option>
<option>Moldavie, République de Moldavie</option>
...
<option>Sint Maarten (partie néerlandaise)</option>
...
<option>Taïwan, province de Chine</option>
<option>Tadjikistan</option>
<option>Tanzanie, République-Unie de Tanzanie</option>
...
<option>Venezuela, République bolivarienne</option>
